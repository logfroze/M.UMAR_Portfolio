...
const creativeItems = [
  ...
  { id: 3, title: 'Social Media Campaign', category: 'Social Media', icon: FaInstagram, color: '#d2a8ff' },
  { id: 4, title: 'Product Photography', category: 'Content Creation', icon: FaCamera, color: '#3fb950' },
  ...
  { id: 7, title: 'Infographic Design', category: 'Poster Design', icon: MdBrush, color: '#79c0ff' },
      ...
      <div className="container">
        ...
        <div className="creative-grid">
          {creativeItems.map((item, i) => (
            <motion.div
              key={item.id}
              className={`creative-card ${i === 0 || i === 5 ? 'creative-card-lg' : ''}`}
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
